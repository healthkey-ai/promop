...
urlpatterns = [
    ...
    path('code-mappings/propose-all/', propose_all_code_mappings, name='v1-code-mapping-propose-all'),
    path('code-mappings/vocabularies/', code_mapping_vocabularies, name='v1-code-mapping-vocabularies'),
    path('code-mappings/<int:concept_id>/', code_mapping_detail, name='v1-code-mapping-detail'),
