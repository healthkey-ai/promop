...
| PH.1.2 | Manage demographic information | ✅ | `Person` demographic API + `PatientHome` General tab; mapped clinical PatientRecord tuples are routed OMOP-first and re-derived, while projection-owned fields without an OMOP home persist directly | #264/#489 |
