...
| PH.1.2 | Manage demographic information | ✅ | `Person` demographic API + `PatientHome` General tab; mapped clinical facts are written to OMOP, while only projection-owned PatientRecord fields without an OMOP home remain writable | #264/#489 |
