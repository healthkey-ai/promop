...
Created: 2026-09-14. Updated: 2026-09-14. Status: implementation in progress;
release verification remains outstanding unless explicitly recorded below.
...
- [ ] **PHR authentication — [#750](https://github.com/healthkey-ai/promop/issues/750).**
  ...
  **Decision (2026-09-14): PHR ships in 1.3. Vlad owns phr#65 and phr#66.**
  The release owner authorized sending Vlad the
  [complete 1.3 compatibility requirements](https://github.com/healthkey-ai/phr/issues/65#issuecomment-5661396962).
  PHR implementation/configuration evidence is with Vlad; continue independent
  PROMOP preparation and verify federation on the final candidate.
  ...
  Browser-session hardening alone does not satisfy this gate.
...
| Render deployment and smoke evidence | Read-only unit audit at 2026-09-14 07:20 UTC: 1,000 latest ANC and 1,000 latest platelet rows lack source units/UCUM evidence and would become unknown under #1289; no pending canonical edits in that scope. No backfill performed; do not infer units. The 0233 merge repair reached dev through #1291; duplicate PR #1296 was closed. Further migration integration, including the existing empty 0235, belongs to the other terminal. Web and worker both reached repair commit `9395579`; newer dev deployments were still rolling out at the last check, so final candidate readiness remains unverified. Exact-candidate deployment, login/federation, edit, import and worker smoke checks remain pending. |
