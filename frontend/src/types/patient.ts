...
export interface PatientInfo {
  ...
  first_line_component_class_ids?: number[] | null;
  second_line_component_class_ids?: number[] | null;
  later_component_class_ids?: number[] | null;
  therapy_component_class_ids?: number[] | null;
