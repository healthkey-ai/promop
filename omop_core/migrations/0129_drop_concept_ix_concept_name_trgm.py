...
class Migration(migrations.Migration):
    ...
    # the functional `ix_concept_name_upper_trgm` (migration 0128) is built and
    ...
    # so this migration is non-atomic. Because 0128 is recorded before this runs,
    # a failure here leaves the new index in place — search stays indexed and the
    # drop simply retries.
    atomic = False

    dependencies = [
        ('omop_core', '0128_concept_ix_concept_name_upper_trgm'),
    ]
