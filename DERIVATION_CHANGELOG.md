...
| 5       | 2026-08-11 | Populate `date_of_birth` from Person year/month/day when full precision is available, and compute `patient_age` with the birthday-passed adjustment (issue #456) |
