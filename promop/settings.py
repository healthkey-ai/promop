"""
Django settings for PRomop project.
...
# (for the SPA catch-all in promop.urls) and WhiteNoise (for index.html and the
# hashed assets) — see promop/frontend_paths.py for why they must agree.
...
MIDDLEWARE = [
    ...
    # promop/whitenoise.py.
    'promop.whitenoise.PromopWhiteNoise',
...
WSGI_APPLICATION = 'promop.wsgi.application'
...
OAUTH2_PROVIDER = {
    'OAUTH2_VALIDATOR_CLASS': 'promop.oauth.SessionOnlyBrowserValidator',
    'SCOPES': {
